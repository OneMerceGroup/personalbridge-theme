	...
	<div class="install-app pb-tab">
		<div class="border-b border-gray-200">
			<nav class="-mb-px flex space-x-8" aria-label="Tabs">
				...
				<a href="#" data-tab_id="woocommerce-plugin" class="pb-tab-label border-transparent text-gray-500 hover:text-indigo-700 hover:border-indigo-600 group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm">
					<svg class="text-gray-400 group-hover:text-indigo-700 -ml-0.5 mr-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28px" height="28px">
		...
		<div class="w-full pt-4 pb-tab-contents">
			...
			<div class="pb-tab-content hidden" data-tab_id="woocommerce-plugin">
				...
				<p class="text-sm text-gray-500">
					<strong>Step 3: </strong>Explore & enjoy <strong>PersonalBridge's</strong> power features.
				</p>
			</div>
